...
import { Linkedin, Github, Dribbble, Youtube, Music } from 'lucide-react';
        ...
        <div className="container">
          ...
          <div className="row g-4">
            <div className="col-md-6 col-lg-6">
              <Link to="/project/nebusis" className="project-card-link">
            ...
            {/* Project 2 */}
            <div className="col-md-6 col-lg-6">
              <Link to="/project/qurado" className="project-card-link">
                <div className="project-card">
            ...
            {/* Project 3 */}
            <div className="col-md-6 col-lg-6">
              <Link to="/project/naesor" className="project-card-link">
                <div className="project-card">
            ...
            {/* Project 4 */}
            <div className="col-md-6 col-lg-6">
              <Link to="/project/bruvue" className="project-card-link">
                <div className="project-card">
