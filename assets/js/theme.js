...
var getColor = function getColor(name) {
  ...
  return getComputedStyle(dom).getPropertyValue("--rjfa-".concat(name)).trim();
};
...
var getBreakpoint = function getBreakpoint(el) {
  ...
  if (classes) {
    breakpoint = breakpoints[classes.split(' ').filter(function (cls) {
      return cls.includes('navbar-expand-lg') || cls.includes('navbar-expand-md') || cls.includes('navbar-expand-sm') || cls.includes('navbar-expand-xl');
    }).pop().split('-').pop()];
  }
